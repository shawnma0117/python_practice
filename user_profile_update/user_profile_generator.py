...
dp1='/home/ads_inno/shawnma/ff_and_tl/tl_click_pf_raw.txt'
...
profile = pd.read_csv(dp1, sep='|', encoding='utf-8', header=None, 
                      names=['user_log_acct','cpp_base_ulevel','cpp_base_age','cpp_base_sex',
                             ...
                             'cfv_brand_favor'], index_col=False)
...
filename="toplife_click_pf.xlsx"
